...
var submit = document.querySelector('input[value="Open form"]');
...
var clear = document.querySelector('input[value="Clear form"]');
...
var insertNicknameButton = function() {
  ...
  nicknameAdd.value = 'Enter Nickname';
...
var addNickname = function() {
  ...
  document.querySelector('input[value="Enter Nickname"]').remove();
};

var nickname = document.querySelector('input[value="Enter Nickname"]');
